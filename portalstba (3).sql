...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 12, 2019 at 02:15 PM
...
(16, 1, 5, 'SPA', 'SPA', 10000000),
(17, 1, 6, 'SPA ', 'SPA', 10000000),
(18, 1, 1, 'SPP Tetap', 'SPP Tetap', 1500000),
(19, 2, 7, 'SPP Tetap', 'SPP Tetap', 2500000),
(21, 1, 1, 'Kesehatan', 'Kesehatan', 50000),
(22, 1, 1, 'SPA Reguler', 'SPA', 12500000),
(23, 1, 2, 'SPP Tetap', 'SPP Tetap', 2500000),
(24, 1, 2, 'SPA ', 'SPA', 7000000);
...
('6', 'XSS', 'XS', '2018-01-01', 'L', 'Kristen', 2, 7, 25, 2016, 3, 2, 0, NULL, 1);
...
--
-- Dumping data for table `tbl_rekappembayaran`
--

INSERT INTO `tbl_rekappembayaran` (`id_rekap`, `nim`, `tipe_pembayaran`, `sks`, `tanggal`, `status_bayar`, `jumlah_dibayarkan`, `catatan`) VALUES
(53, '1', 11, NULL, '2019-04-07', '2', 10500000, 'wis lunas gan'),
(54, '1', 12, 20, '2019-03-27', '2', 5000000, ''),
(55, '5', 13, 20, '2019-03-27', '2', 3000000, ''),
(56, '5', 16, NULL, '2019-03-27', '2', 10000000, ''),
(57, '6', 19, NULL, '2019-03-27', '2', 2500000, ''),
(58, '1', 18, NULL, '2019-03-28', '2', 1500000, ''),
(59, '1', 21, NULL, '2019-03-29', '2', 50000, ''),
(60, '2', 23, NULL, '2019-04-03', '1', 1000000, ''),
(61, '1', 18, NULL, '2019-04-05', '2', 1500000, ''),
(62, '1', 12, 20, '2019-04-07', '2', 5000000, '');
...
--
ALTER TABLE `tbl_rekappembayaran`
  MODIFY `id_rekap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;
