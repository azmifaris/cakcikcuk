          ...
          <div id="basic-tab" class="col s12">
            <form class="row" id="basic-form" method="post" action="" style="margin-top: 20px;" enctype="multipart/form-data">
              ...
              <div class="input-field col s12 m6">
                  <input id="nama" name="nama" type="text" value="<?php echo $this->session->userdata('user_name'); ?>">
                  <label for="nama" class="">Nama</label>
              </div>
              <div class="input-field col s12 m6">
                  <input id="alamat" name="alamat" type="text" value="<?php echo $this->session->userdata('user_email'); ?>">
              ...
              <div class="input-field col s12 m6">
                  <input id="telp" name="telp" type="number" value="<?php echo $this->session->userdata('alamat'); ?>">
