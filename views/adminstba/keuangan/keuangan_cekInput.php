                            ...
                            <div class="content">
                                <form class="form-horizontal" role="form" action="<?php echo site_url('admin/keuangan/Keuangan_rekap/tambah_aksi') ?>" method="Post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" id="form-field-1" placeholder="NIM" class="form-control" readonly="" name="nama_bayar" value="<?php echo $row->nama_pembayaran;?>" />
                                        </div>
                                    </div>
                                    <div class="form-group" hidden="">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><h5> Jenis Pembayaran </h5></label>
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" id="form-field-1" placeholder="NIM" class="form-control" readonly="" name="tipe_bayar" value="<?php echo $row->jenis_pembayaran;?>" />
                                        </div>
                                    </div>
                                    <div class="form-group">
