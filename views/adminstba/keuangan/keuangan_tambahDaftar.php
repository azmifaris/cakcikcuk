                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="header" style="padding-bottom: 20px">
                                <h4 class="title">TAMBAH DAFTAR PEMBAYARAN</h4>
                            </div>
                        </div>
                            <div class="content">
                                <form class="form-horizontal" role="form" action="<?php echo site_url('admin/keuangan/Keuangan_daftarPembayaran/tambah_aksi') ?>" method="Post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" id="form-field-1" placeholder="Jenis Pembayaran" class="form-control"  name="nama_pembayaran"/>
...
<!--                                               <option value="Lain-lain">Lain-lain</option>
 -->                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="number" id="form-field-1" placeholder="Jumlah" class="form-control"  name="jumlah"/>
                                        </div>
                                    </div>
