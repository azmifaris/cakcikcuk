                        ...
                        <div class="card">
                            ...
                            <table class="table table-hover" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                         <?php
    										                  $no=1;	
                                              if($semester_list->num_rows() > 0)
                                              {
                                                  foreach ($semester_list->result() as $row) {
                                              ?>
                                                  <tr>
                                                      <td><?php echo $no;?></td>
                                                      ...
                                                      <td>                                                
		                                              	<form action="<?php echo site_url('admin/keuangan/Keuangan_daftarPembayaran/detail')?>" method="POST">
                                                        
                                                      <div class="" hidden="">
                                                        <input type="" name="id_jurusan" value="<?php echo $row->id_jurusan;?>">
                                                        <input type="" name="nama_semester" value="<?php echo $row->nama_semester;?>">
                                                      </div>
