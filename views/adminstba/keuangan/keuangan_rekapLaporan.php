        ...
        <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h3 class="title">Laporan Rekap Pembayaran </h3>
                                              ...
                                              ?>
                                                  <tr>
                                                      ...
                                                      <td>
                                                          ...
                                                          <a href="<?php echo site_url('admin/keuangan/Keuangan_rekap/cetak_data/').$row->id_rekap ?>"><button class="btn btn-fill "><i class="pe-7s-print"></i></button></a>
                                                      </td>
