            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h3 class="title">Data SPP Tetap </h3>
                            ...
                            <div class="header">
                                ...
                                <!-- <table class="col-md-12">
                                    <tr>
                                        ...
                                        <form action="<?php echo site_url('admin/Keuangan_rekap/cari_SPPTetap') ?>" method="POST">
                            ...
                            <div class="content table-responsive table-full-width">
                                <table class="table table-hover table-striped table-responsive">
                                    ...
                                    <tbody>
                                      <?php
                                              $no=1;
                                              if($SPPTetap->num_rows() > 0)
                                              {
                                                  foreach ($SPPTetap->result() as $row) {
                                              ?>
                                                  <tr>
                                                      <td><?php echo $no;?></td>
