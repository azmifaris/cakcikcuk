                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="header" style="padding-bottom: 20px">
                                <h4 class="title">LIHAT DATA PEMBAYARAN</h4>
                            </div>
                        </div>
                            <div class="content">
                                    <form class="form-horizontal" role="form" action="<?php echo site_url('admin/keuangan/Keuangan_rekap/laporan') ?>" method="Post">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><h5> Mulai </h5></label>

                                        <div class="col-sm-5">
                                            <input type="date" id="form-field-1" placeholder="tgl_awal" class="form-control" name="tgl_awal" required="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="form-field-1"><h5> Hingga </h5></label>

                                        <div class="col-sm-5">
                                            <input type="date" id="form-field-1" placeholder="tgl_akhir" class="form-control" name="tgl_akhir" required="" />
                                        </div>
                                    </div>
