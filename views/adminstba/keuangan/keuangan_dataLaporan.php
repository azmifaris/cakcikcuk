                            ...
                            <div class="header">
                               <table class="col-md-12">
                                    <tr>
                                        ...
                                        <td class="">
                                           <a href="<?php echo site_url('admin/keuangan/Keuangan_rekap/reset_status') ?>"> <button class="btn btn-danger btn-fill"><i class="pe-7s-repeat"></i> Reset</button></a>
                                        </td>
                                    ...
                                    <tbody>
                                      <?php
                                              ...
                                              ?>
                                                  <tr>
                                                      <td><?php echo $no;?></td>
                                                      <td> <a href="<?php echo site_url('admin/keuangan/Keuangan_rekap/detail_mahasiswa/').$row->nim ?>"><?php echo $row->nim;?></a></td>
                                                      ...
                                                      <td><?php ?>
                                                          ...
                                                          <input type="submit" class="btn btn-fill btn-success" value="ACC"> <?php };?>
                                                          </form>
                                                      </td>
                                                      <td>
                                                        <?php
                                                          $row->spa;
                                                          if($row->spa == 0){?>
                                                          <div style="color: red"><?php echo "Belum Bayar";?></div>
                                                          <?php }else if($row->spa == 1){?>
                                                          <div style="color: orange"><?php echo "Belum Lunas";?></div>
                                                          <?php }else { ?>
                                                          <div style="color: blue"><?php echo "Lunas";?></div>
                                                        <?php };?>
                                                      </td>
                                                      <td>
                                                        <?php
                                                      ...
                                                      <td>
                                                        <?php
                                                          ...
                                                          <div style="color: red"><?php echo "Belum Bayar";?></div>
                                                          <?php }else if($row->spp_variabel == 1){?>
                                                          <div style="color: orange"><?php echo "Belum Lunas";?></div>
                                                          <?php }else { ?>
                                                          <div style="color: blue"><?php echo "Lunas";?></div>
                                                        <?php };?>
                                                      ...
                                                      <td>
                                                        <?php
                                                          ...
                                                          <div style="color: red"><?php echo "Belum Bayar";?></div>
                                                          <?php }else if($row->kemahasiswaan == 1){?>
                                                          <div style="color: orange"><?php echo "Belum Lunas";?></div>
                                                          <?php }else { ?>
                                                          <div style="color: blue"><?php echo "Lunas";?></div>
                                                        <?php };?>
